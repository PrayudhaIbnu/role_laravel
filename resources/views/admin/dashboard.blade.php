                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <caption
                            ...
                            <div class="inline-flex justify-between float-right me-2 ">
                                <form action="{{ route('admin.dashboard') }}" method="GET"
                                class="flex items-center gap-2">
                                <input type="text" name="search" value="{{ request('search') }}"
                                    class="w-50 px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center items-center gap-4">
                                            <div class="inline-flex rounded-md shadow-sm" role="group">
                                                ...
                                                <form action="{{ route('account.destroy', $dataUser->id) }}"
